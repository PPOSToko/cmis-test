              ...
              <div className="row">
                <div className="col-lg-6 col-sm-6 col-12">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text"  placeholder='Nama User' value={items?.nama} onChange={(e)=>setNama(e.target.value)} />
                  </div>
                ...
                <div className="col-lm-12">
                      <button className="btn btn-submit me-3 " onClick={EditUser}>Simpan</button>
