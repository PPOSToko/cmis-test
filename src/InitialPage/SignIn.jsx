            ...
            <div className="login-content">
              <div className="login-userset">
                ...
                <div className="login-userheading">
                  <h3>Hai 👋</h3>
                  <h4>
                    Silahkan login terlebih dahulu untuk bisa menggunakan fitur
                    di CMIS
                  </h4>
                </div>
                ...
                >
                  ...
                  <label>
                    All data and programs CMIS is owned by PT. Cahaya Jakartaand
                    are not allowed misuse or copiedwithout permission of the
                    company.
                  </label>
                </div>
              </div>
